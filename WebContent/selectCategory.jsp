...
<nav class="navbar navbar-expand-lg navbar-mainbg bg-primary">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <form class="form-inline my-2 my-lg-0" action="SearchedProduct">

      <input class="form-control mr-sm-2" type="search" placeholder="Search"  name="med" aria-label="Search">
...
<div align="center">
<br><br>
<h1>Welcome to Category Search</h1><br>
<h2>Please select an appropriate category to search medicines</h2><br>
...
<br>
<a href="welcomeCustomer.jsp" class="btn btn-primary">Click to go to your Profile</a>
</div>
</div>
<br><br><br>
