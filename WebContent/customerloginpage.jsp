		...
		<div class="row main-content bg-primary text-center">
			...
			<div class="col-md-8 col-xs-12 col-sm-12 login_form ">
				<div class="container-fluid">
					...
					<div class="row">
						<form action="CustomerLogin" method="get" class="form-group">
							<div class="row">
								<input type="text" name="email" id="cemail" class="form__input" placeholder="Email">
							</div>
							<div class="row">
							...
							<div align="center">
                                 <button type="submit" class="btn btn-outline-primary" id="admin-log-btn">Login</button><br>
             
             </div>
						</form>
					</div>
					<div class="row">
						<p>Don't have an account? <a href="customerRegister.jsp" class="btn btn-outline-success"> Register </a></p>
					</div>
				</div>
			</div>
		</div>
