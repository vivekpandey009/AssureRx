...
public class SearchedProduct extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Product> list = new LinkedList(dao.searchProductByName(med));
		...
		out.println("<div align='center'><h1>Products</h1></div>");
...
out.println("<div align='center'><a href='selectCategory.jsp' class='btn btn-primary'>Back</a></div>");
